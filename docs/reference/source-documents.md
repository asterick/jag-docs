<!-- nav:top -->
[🏠 Atari Jaguar Developer Reference](../index.md) ▸ Reference ▸ **Source Provenance**
<!-- /nav:top -->

# Source Provenance

Which source document each page of this reference is built from. For the source
files themselves — descriptions, notes, and downloads — see the
[source files index](../sources/index.md).
...
| [CD-ROM Subsystem Overview](../cdrom/overview.md) | *Jaguar CD-ROM* developer manual (scanned) |
| [CD-ROM BIOS API](../cdrom/bios-api.md) | *Jaguar CD-ROM* developer manual (scanned) |
| [Disc & Data Format](../cdrom/data-format.md) | *Jaguar CD-ROM* developer manual (scanned) |
| [CD-ROM Programming Procedures & Guidelines](../cdrom/programming-guide.md) | *Jaguar CD-ROM* developer manual (scanned) |
| [CD-ROM Hardware](../cdrom/hardware.md) | *Jaguar CD-ROM* developer manual (scanned) |
| [Sample Programs](../examples/sample-programs.md) | *Jaguar Sample Programs* (scanned) |
| [Complete Register List](register-list.md) | *Technical Reference Manual* (V10), pp. 5–7; equate names from `JAGUAR.INC` |
| [RISC Instruction Set (GPU/DSP)](risc-instruction-set.md) | *Software Reference Manual — Tom & Jerry* (V10), pp. 89–106 |
| [Glossary](glossary.md) | — |

## See also

- [Source files index](../sources/index.md) — the original PDFs, with descriptions and download links
- [Home](../index.md)

<!-- nav:bottom -->
---

◀ **Prev:** [Glossary](glossary.md) &nbsp;·&nbsp; 🏠 **[Home](../index.md)** &nbsp;·&nbsp; **Next:** [Source Documents](../sources/index.md) ▶
