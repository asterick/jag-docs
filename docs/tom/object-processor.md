...
- The GPU and Blitter **may not be used in high bus priority while the Object Processor is running.** The **DMAEN** bit of `G_FLAGS` should be `0`, and the **BUSHI** bit of `B_CMD` should be `0`.
